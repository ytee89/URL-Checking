...
class URL(object):
    ...
    def pdfmoddate(self, save_path, key):
        ...
        try:
            ...
            last_update = str(last_update1[key])
    ...
    def dlfile(self, save_path, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36'}):
        #download file from direct url using request
        r = requests.get(self.url,verify=False, timeout=30, headers=headers, stream=True)
